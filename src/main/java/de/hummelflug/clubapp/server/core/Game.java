...
public class Game extends Event {
	 ...
	 */
	public Game(@Nonnull Long creatorUserId, @Nonnull Date startTime, @Nonnull Date endTime, @Nonnull Long hostTeamId
			, @Nonnull Long guestTeamId) {
		super(creatorUserId, EventType.GAME, startTime, endTime);
