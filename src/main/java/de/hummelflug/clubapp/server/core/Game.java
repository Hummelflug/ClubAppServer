...
public class Game extends Event {
	 ...
	 */
	public Game(@Nonnull Long creatorUserId, @Nonnull Date meetingTime, 
			@Nonnull Date startTime, @Nonnull Date endTime, @Nonnull Long hostTeamId,
			@Nonnull Long guestTeamId, String title, Long sportTypeId) {
		super(creatorUserId, EventType.GAME, meetingTime, startTime, endTime, title, sportTypeId);
