...
public class Team {
	...
	@ElementCollection
	@CollectionTable(name = "user_current_team", joinColumns = @JoinColumn(name = "team_id"))
     ...
     */
	public Team(@Nonnull String name, @Nonnull Integer ageClass) {
	...
	public int hashCode() {
		...
		result = prime * result + ((coachUserId == null) ? 0 : coachUserId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (ageClass == null) {
			...
			return false;
		if (coachUserId == null) {
			if (other.coachUserId != null)
				return false;
		} else if (!coachUserId.equals(other.coachUserId))
			return false;
	...
	/**
	 * @param coachUserId the coachUserId to set
	 */
